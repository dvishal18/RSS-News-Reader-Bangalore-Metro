package cdacbangalore.com.gnews.adapters;
...
import cdacbangalore.com.gnews.R;
import cdacbangalore.com.gnews.models.RSSFeed;
import cdacbangalore.com.gnews.utils.ConnectionDetector;
import cdacbangalore.com.gnews.utils.Constants;
import cdacbangalore.com.gnews.utils.NewsFeedParser;
...
public class TabsPagerAdapter extends PagerAdapter implements SwipeRefreshLayout.OnRefreshListener {
    String tabs[] = {""};
    Activity activity;
    ...
    public Object instantiateItem(ViewGroup container, int position) {
      ...
      //  swipeView.setColorSchemeColors(Color.RED);
        ...
        performAsyncTask(progressBar,mRecyclerView);
    ...
    public void performAsyncTask(ProgressBar progressBar,RecyclerView mrecyclerView) {
        ...
        if (isNetworkAvailable) {
            ...
            new DoRssFeedTask(mrecyclerView, progressBar).execute(Constants.TOPSTORIES);
